...
Welcome, Software Engineers becoming AI Data Scientists!
...
`git clone https://github.com/ed-donner/tech2ai.git`

This creates a new directory `tech2ai` within your projects folder and downloads the code for the class.  
Do `cd tech2ai` to go into it. This `tech2ai` directory is known as the "project root directory".
...
Find your tech2ai directory within your projects directory. Double click on tech2ai so you're looking at the contents of tech2ai. Then click Open or Open Folder.

Cursor should then open up tech2ai. You know you're in good shape if you see tech2ai in block caps on the top left.
...
Find your tech2ai directory within your projects directory. Double click on tech2ai so you're looking at the contents of tech2ai. Then click Open.
...
If you're wondering why I rant about this: I get many, many frustrated people contacting me who (despite all my appeals) have named the file something else and think it's OK. It's not OK! It needs to be called `.env` in the tech2ai directory 😂
